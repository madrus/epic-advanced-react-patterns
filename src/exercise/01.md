...
1. We can move all the complex multi-step logic of a state update into an separate function that accepts both dispatch function and any arguments that dispatch may need. In this way, we will make our main code more readable.
